...
x1 = zeros(16,2);
x1(1:4,1:2) = [a(2,1) a(2,2);a(6,1) a(6,2);a(43,1) a(43,2);a(48,1) a(48,2)];
x1(5:8,1:2) = [b(2,1) b(2,2);b(6,1) b(6,2);b(43,1) b(43,2);b(48,1) b(48,2)];
x1(9:12,1:2) = [c(2,1) c(2,2);c(6,1) c(6,2);c(43,1) c(43,2);c(48,1) c(48,2)];
x1(13:16,1:2) = [d(2,1) d(2,2);d(6,1) d(6,2);d(43,1) d(43,2);d(48,1) d(48,2)];
pixels = x1';
%considering the world center at the bottom left corner of the checkeboard
real_pts = [2.4*2 2.4;6 * 2.4 2.4;2.4 8*2.4;6*2.4 8*2.4]; % size of each block on the checkerboard = 2.4cm
X = real_pts;
